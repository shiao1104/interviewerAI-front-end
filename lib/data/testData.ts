...
export const jobData = [
  {
    ...
    headCount: 2,
    education: "大學",
    departmentLimit: "資訊相關科系",
    experience: "需1年以上相關經驗",
    languages: "英文中等以上",
    skills: ["React", "JavaScript", "CSS"],
    description: "負責前端介面開發與優化，與設計與後端工程師協作。",
    category: "軟體工程師",
    management: "無需管理經驗",
    availableDate: "一週內",
    status: "積極徵才中",
    contact: "hr@innotech.com.tw",
  ...
  },
  {
    ...
    position: "行銷專員",
    company: "未來行銷顧問",
    salary: "月薪 35,000~45,000 元，依經驗可議",
    location: "可遠端",
    jobType: "全職",
    workHours: "日班",
    leavePolicy: "依公司規定",
    ...
    description: "負責社群貼文、品牌曝光與活動執行。",
    category: "行銷專員",
    management: "無",
    availableDate: "不限",
    status: "招募中",
    contact: "apply@futuremarketing.com.tw",
    createDate: '2025/5/10',
  },
];
